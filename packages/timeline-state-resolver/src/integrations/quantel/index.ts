...
import { createQuantelStatusDetail } from './errors'
...
export class QuantelDevice implements Device<QuantelDeviceTypes, QuantelState, QuantelCommandWithContext> {
	...
	getStatus(): Omit<DeviceStatus, 'active'> {
		...
		if (this._quantel.statusMessage && !suppressServerDownWarning) {
			statusCode = StatusCode.BAD
			statusDetails.push(createQuantelStatusDetail(QuantelStatusCode.STATUS_MESSAGE, { statusMessage: this._quantel.statusMessage }))
		}
