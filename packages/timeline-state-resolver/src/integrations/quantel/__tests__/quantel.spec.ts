...
import { getResolvedState, ResolvedTimeline, resolveTimeline } from 'superfly-timeline'
...
import { convertResolvedTimelineObjectToDeviceTimelineStateObject } from '../../../lib'
...
function getResolvedDeviceState(
	resolvedTimeline: ResolvedTimeline<TSRTimelineContent>,
	time: Timeline.Time
): DeviceTimelineState {
