...
import { DeviceType, TimelineContentTypeOgraf, MappingOgrafType } from 'timeline-state-resolver-types'
...
import { OGrafDevice } from '..'
import { getDeviceContext } from '../../__tests__/testlib'
import { OGrafDeviceState } from '../ografState'
...
const DEFAULT_RESOLVED_OBJECT_INSTANCE: Pick<
	ResolvedTimelineObjectInstance<any>,
	'enable' | 'instance' | 'layer' | 'resolved'
> = {
	enable: { start: 0 },
	instance: {
		start: 0,
