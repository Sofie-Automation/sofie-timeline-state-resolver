...
import { DeviceStatusDetail } from '../deviceError'
...
export type VizMSEStatusDetail<T extends VizMSEStatusCode = VizMSEStatusCode> = DeviceStatusDetail<T, VizMSEStatusContextMap[T]>
